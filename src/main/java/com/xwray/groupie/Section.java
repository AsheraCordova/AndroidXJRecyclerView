...
public class Section extends NestedGroup {
    @Nullable
    private RVGroup header;

    @Nullable
    private RVGroup footer;

    @Nullable
    private RVGroup placeholder;

    private final ArrayList<RVGroup> children = new ArrayList<>();
    ...
    public Section() {
        this(null, new ArrayList<RVGroup>());
    }

    public Section(@Nullable RVGroup header) {
        this(header, new ArrayList<RVGroup>());
    }

    public Section(@NonNull Collection<? extends RVGroup> children) {
        this(null, children);
    }

    public Section(@Nullable RVGroup header, @NonNull Collection<? extends RVGroup> children) {
        this.header = header;
        if (header != null) {
     ...
     */
    public void update(@NonNull final Collection<? extends RVGroup> newBodyGroups) {
     ...
     */
    public void update(@NonNull final Collection<? extends RVGroup> newBodyGroups, boolean detectMoves) {
        final List<RVGroup> oldBodyGroups = new ArrayList<>(children);
     ...
     * @param diffResult
     */
    public void update(@NonNull final Collection<? extends RVGroup> newBodyGroups, DiffUtil.DiffResult diffResult) {
     ...
     */
    public void setPlaceholder(@NonNull RVGroup placeholder) {
    ...
    public void setHeader(@NonNull RVGroup header) {
        if (header == null)
    ...
    public void setFooter(@NonNull RVGroup footer) {
        if (footer == null)
