...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public View onFocusSearchFailed(View focused, int direction,
        ...
        for (int i = start; i != limit; i += inc) {
            ...
            if (false && spanGroupIndex != focusableSpanGroupIndex) {
            ...
            if (false && candidateStart == prevSpanStart
                    && candidateEnd == prevSpanEnd) {
                return candidate; // perfect match
            }
            boolean assignAsWeek = false;
            if ((false && focusableWeakCandidate == null)
                    || (!false && unfocusableWeakCandidate == null)) {
                assignAsWeek = true;
            } else {
